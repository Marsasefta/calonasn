    ...
    <div class="collapse navbar-collapse" id="sidenavNavbar">
      <div class="navbar-nav flex-column mt-4 mt-lg-0 d-flex flex-column gap-3">
        <ul class="list-unstyled mb-0">
          <!-- Nav item -->
          <li class="nav-item">
            <a class="nav-link" href="dashboard-instructor.php">
          ...
          <li class="nav-item">
            <a class="nav-link" href="instructor-reviews.php">
              <i class="fe fe-star nav-icon"></i>
           Reviews
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="instructor-earning.php">
              <i class="fe fe-pie-chart nav-icon"></i>
              Earnings
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="instructor-order.php">
          ...
          <li class="nav-item">
            <a class="nav-link" href="instructor-payouts.php">
              <i class="fe fe-dollar-sign nav-icon"></i>
              Payouts
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="instructor-quiz.php">
              <i class="fe fe-help-circle nav-icon"></i>
              Quiz
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="instructor-quiz-result.php">
              <i class="fe fe-help-circle nav-icon"></i>
              Quiz Result
            </a>
          </li>
