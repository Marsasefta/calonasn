...
<nav class="navbar navbar-expand-lg">
  <div class="container px-0">
    <a class="navbar-brand" href="index.php"><img src="/build/assets/images/mentor/geeks-mentor.svg" alt="Geeks" /></a>
      ...
      <ul class="navbar-nav mx-auto">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarLanding">
            ...
            <li>
              <a href="landing-course-lead.php" class="dropdown-item">Lead Course</a>
            </li>
            <li>
              <a href="landing-request-access.php" class="dropdown-item">Request Access</a>
            </li>
