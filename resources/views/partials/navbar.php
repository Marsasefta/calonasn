        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-arrow" aria-labelledby="navbarPages">
            <li class="dropdown-submenu dropend">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="course-filter-grid.php">Course Grid</a></li>
                <li><a class="dropdown-item" href="course-filter-list.php">Course List</a></li>
                <li class="border-bottom my-2"></li>
                <li><a class="dropdown-item" href="pages-course-category.php">Course Category v1</a></li>
                <li><a class="dropdown-item" href="course-category-v2.php">Course Category v2</a></li>
                <li class="border-bottom my-2"></li>
                <li><a class="dropdown-item" href="course-single.php">Course Single v1</a></li>
                <li><a class="dropdown-item" href="course-single-v2.php">Course Single v2</a></li>
                <li><a class="dropdown-item" href="course-single-v3.php">Course Single v3</a></li>
                <li class="border-bottom my-2"></li>
                <li><a class="dropdown-item" href="course-resume.php">Course Resume</a></li>
                <li><a class="dropdown-item" href="course-checkout.php">Course Checkout</a></li>
                <li><a class="dropdown-item" href="add-course.php">Add New Course</a></li>
              </ul>
            </li>
            <li>
              <a class="dropdown-item" href="dashboard-project.php">
                Projects
                <span class="badge bg-primary ms-2">New</span>
              </a>
            </li>
            <li>
              <a class="dropdown-item" href="dashboard-quiz.php">
                Quizzes
                <span class="badge bg-primary ms-2">New</span>
              </a>
            </li>
