...
<nav class="navbar navbar-expand">
    <div class="container px-0">
        <div class="d-flex align-items-center">
            <a class="navbar-brand me-4" href="index.php"><img src="/build/assets/images/brand/logo/logo.svg" alt="Geeks" /></a>

            <ul class="list-unstyled mb-0 lh-1">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarBrowse" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-bs-display="static">
                        Help Center
                    </a>
    ...
    <div class="ms-auto d-flex align-items-center">
        ...
        <div class="d-flex align-items-center">
            <a href="#" class="ms-2 me-md-4" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                <i class="fe fe-search fs-3"></i>
            </a>
            <a href="help-center-support.php" class="btn btn-primary d-lg-block d-none">Submit Ticket</a>
        </div>
    </div>
    <!-- Collapse -->
</nav>
