    ...
    <div class="row gy-4">
      <div class="col-lg-4 col-12">
        ...
        <div class="d-flex flex-column gap-4">
          <div>
            <img src="/build/assets/images/mentor/geeks-mentor.svg" alt="Geeks" class="" />
          </div>
          <div>
            <p class="mb-0 txet-gray-500">Connecting founders and marketers with battle-hardened mentors that genuinely
              enjoy helping people.</p>
          </div>
          <!-- Instagram -->
