    ...
    <div class="container px-0">
        ...
        <div class="collapse navbar-collapse" id="navbar-default">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link" href="landing-job.php">Home</a>
                </li>
                    ...
                    <ul class="dropdown-menu dropdown-menu-arrow dropdown-menu-end" aria-labelledby="navbarPages">
                        ...
                        <li class="dropdown-submenu dropend">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="dropdown-item" href="company-about.php">About</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="company-reviews.php">Reviews</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="company-jobs.php">Jobs</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="company-benefits.php">Benifits</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="company-photos.php">Photos</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a class="dropdown-item" href="job-post-job.php">Post A Job</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="job-upload-resume.php">Upload Resume</a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="index.php">Back to Demo</a>
                </li>
                <li class="nav-item dropdown">
