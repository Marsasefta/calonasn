            ...
            <div class="row align-items-center gy-6 gy-xl-0">
                ...
                <div class="col-lg-6 col-12 text-center">
                    <div class="bg-light p-4 p-md-5 rounded-4 border shadow-sm">
                        <div class="badge bg-danger-soft text-danger mb-3 px-3 py-2 fw-bold text-uppercase tracking-wider">
            ...
            <div class="row g-4 text-center">
                <div class="col-md-4 col-12">
                    <div class="p-3">
                        ...
                        <span class="d-block display-3 fw-bold text-primary-soft mb-2 opacity-50" style="color: #cbdffa;">01</span>
                ...
                <div class="col-md-4 col-12">
                    <div class="p-3">
                        <span class="d-block display-3 fw-bold text-primary-soft mb-2 opacity-50" style="color: #cbdffa;">02</span>
                ...
                <div class="col-md-4 col-12">
                    <div class="p-3">
                        <span class="d-block display-3 fw-bold text-primary-soft mb-2 opacity-50" style="color: #cbdffa;">03</span>
