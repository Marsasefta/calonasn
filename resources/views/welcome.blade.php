          ...
          <div class="row align-items-center gy-5">
            ...
            <div class="col-lg-5 col-12 d-none d-lg-block">
              <div class="hero-image text-center position-relative">
                <img src="/build/assets/images/hero2.png" alt="Professional working on career development" class="img-fluid" style="max-width: 85%; border-radius: 16px; box-shadow: var(--shadow-large);" />
