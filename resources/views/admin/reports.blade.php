            ...
            <div class="row mb-4">
                <div class="col-12 d-flex flex-column flex-md-row justify-content-between align-items-start gap-3">
                    <div>
                        ...
                        <p class="text-muted mb-0">Lihat rekap nilai peserta dan export laporan ke file spreadsheet untuk pengumuman.</p>
                    </div>
                    <div>
                        ...
                        <tbody>
                            @forelse($reports as $report)
                                <tr>
                                    ...
                                    <td>{{ $report->start_time && $report->end_time ? $report->end_time->diffInMinutes($report->start_time) . ' menit' : '-' }}</td>
                                </tr>
                            @empty
                                <tr>
