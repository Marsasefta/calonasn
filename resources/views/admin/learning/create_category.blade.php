    ...
    <div id="db-wrapper">
      ...
      <main id="page-content">
        ...
        <section class="container-fluid p-4">
          <div class="card">
            <div class="card-body">
              <h4>Tambah Kategori Materi Pembelajaran</h4>
              @if($errors->any())
              ...
              <form method="POST" action="{{ route('admin.learning.store') }}">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" name="icon" class="form-control" placeholder="fe fe-book">
                </div>
                <div class="mb-3">
                  <label class="form-label">Tema Warna</label>
                  <input type="text" name="color_theme" class="form-control" placeholder="primary, success, danger">
                </div>
