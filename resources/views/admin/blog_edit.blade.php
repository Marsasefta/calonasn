                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="title" class="form-control form-control-lg" placeholder="Masukkan judul artikel..." required value="{{ old('title', $post->title) }}">
                                    </div>
                                    <div class="mb-3">
                            ...
                            <div class="card mb-4 border-start border-3 border-success">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="excerpt" rows="3" class="form-control" placeholder="Tulis ringkasan konten untuk cuplikan Google... (Max 160 karakter)">{{ old('excerpt', $post->excerpt) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <select name="status" class="form-select">
                                            ...
                                            <option value="draft" {{ old('status', $post->status) == 'draft' ? 'selected' : '' }}>Draft (Simpan Internal)</option>
                                        </select>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="mb-3 text-center">
                                        @if($post->image_url)
                                            <div class="mb-2">
                                                ...
                                                <img src="{{ $post->image_url }}" alt="Current Image" class="img-fluid rounded border shadow-sm mb-2" style="max-height: 150px; object-fit: cover;">
                                            </div>
                                        @endif
