                        ...
                        <div class="card-body p-6 d-flex flex-column gap-4">
                            ...
                            <form method="POST" action="{{ route('login') }}" class="needs-validation" novalidate>
                                ...
                                {{-- <div class="mt-4 text-center">
                                    <p class="text-muted small mb-3">Atau masuk menggunakan akun media sosial:</p>
                                    <a href="#" class="btn-social btn-social-outline btn-facebook mx-1">
                                    ...
                                    <a href="#" class="btn-social btn-social-outline btn-twitter mx-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                    ...
                                    <a href="#" class="btn-social btn-social-outline btn-linkedin mx-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                    ...
                                    <a href="#" class="btn-social btn-social-outline btn-github mx-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
