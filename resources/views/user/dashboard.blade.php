                    ...
                    <div class="card border-0 shadow-sm rounded-4"
                        ...
                        <div
                            ...
                            <div class="mb-3 mb-md-0">
                                <div class="mb-3">
                                    @if ($isPaketLengkapPdf)
                                        {{-- Diubah dari "Tryout + PDF Kit" menjadi "Tryout + Materi Pembelajaran" --}}
                                        <span class="badge bg-white text-primary px-3 py-2 rounded-pill shadow-sm">
                                            <i class="bi bi-star-fill text-warning me-1"></i> Member Tryout + Materi
                                            Pembelajaran
                                        </span>
                                    @elseif($isPaketTryoutSaja)
                                        <span class="badge bg-white text-success px-3 py-2 rounded-pill shadow-sm">
                                            <i class="bi bi-check-circle-fill me-1"></i> Member Tryout Mandiri
                                        </span>
                                    @else
                                        <span class="badge bg-dark bg-opacity-25 text-white px-3 py-2 rounded-pill">
                                            <i class="bi bi-person-fill me-1"></i> Member Gratisan
                                        </span>
                                    @endif
                                </div>
        ...
        <div class="position-relative">
            <div class="position-absolute top-0 start-0 w-100 h-100 d-flex flex-column align-items-center justify-content-center rounded-4"
                ...
                <div class="bg-white p-4 rounded-4 shadow-lg text-center border" style="max-width: 400px;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#6c757d" class="mb-3"
                        viewBox="0 0 16 16">
                        <path
                ...
                Swal.fire({
                    ...
                    html: `
                        <p class="text-start mb-2" style="text-align: justify; text-justify: inter-word; line-height: 1.5;">
                            Biar belajarnya makin sat-set dan mimin gampang ngabarin kalau ada info penting (atau promo rahasia!), bisikin nomor WhatsApp kamu di bawah ini dong.
                        </p>
